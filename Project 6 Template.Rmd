...
n_sims <- 2000 #LL note on 3/29: just doing 1000 for now because it always breaks at some point at 10k 
...
n_sims <- 2000 #LL note on 4/4: just doing 1000 for now, but we can up this and hopefully won't break
ATTam <- c()
